...
**Before requesting support please consider that AKBL is not actively developed.** I created it in 2014 for managing my Alienware M14X-R1 but I changed of computer it in 2022. Even if I want to help the other users of the GNU/Linux community, I don't have the time or the hardware to do it.**
