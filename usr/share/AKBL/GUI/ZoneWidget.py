...
class ZoneWidget(Gtk.Frame):
    ...
    def __init__(self,
        ...
        self.__left_drawing_area.set_size_request(self.__width, self.__height)
        self.__right_drawing_area.set_size_request(self.__width, self.__height)
    ...
    def __on_drawingarea_click(self, _, event, area_number):
    ...
    def __on_command_button_click(self, widget, *_):
    ...
    def __on_draw_drawingarea(self, widget, cr, area_number):
        ...
        lg1 = cairo.LinearGradient(0.0, 0.0, self.__width, 0)
        ...
        cr.set_source(lg1)
        cr.fill()
        widget.queue_draw_area(0, 0, self.__width, self.__height)
